...
class Movies extends MY_Controller {
	...
	public function rating() {
		...
		$this->data['rating_film'] = $this->films_model->getMoviesOnPage($row_count, $offset, 1);
		

		if($this->data['rating_film'] == null) {
			show_404();
		}
	...
	public function view($slug = NULL) {
		...
		$this->data['descriptions_movies'] = $movie_slug['descriptions'];
